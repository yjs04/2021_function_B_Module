class Culture{
    ...
    makeCultureItem({id,culture_name,culture_image}){
        ...
        if(culture_image !== "/xml/image/") dom.querySelector(".culture_item_img").innerHTML = `<img src="${culture_image}" src="culture_image">`;
        ...
        return fetch("/xml/nihList.xml")
                ...
                .then(async xmlText =>{
                    ...
                    let cultures = Array.from(xml.querySelectorAll("item")).map(culture=>({
                        ...
                        culture_name:culture.querySelector("ccbaMnm1").innerHTML,
    ...
    getXmlDetail(url){
        ...
        .then(xml =>{
            ...
            return `/xml/image/${item.querySelector("imageUrl").innerHTML}`;
        });
    }
}
